...
var get_user = function(email) {
   ...
   //console.log(doc.id, " => ", doc.data());  
       ...
       <div style="padding-top:20px;">
       <input type="button" class="btn btn-danger" value="Salir del Editor y Regresar" onclick="window.open('user.html')"/>
       <div>- - - - - - - - - - - - - - - - - - - -  </div>
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - -//
 ...
 //- - - - - - - - -  update Nombre tutor - - - - - - - - - - - -//  
  var push_to_firebasez = function(data){
      var db = firebase.firestore();
