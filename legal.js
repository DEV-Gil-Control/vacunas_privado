   ...
   querySnapshot.forEach((doc) => {
    //doc.data() is never undefined for query doc snapshots
     console.log(doc.id, " => ", doc.data());
       ...
       todosd.innerHTML = `<div><strong>Nombre del padre, madre o tutor:</strong> ${document.urlParams.getAll('ID')," => " doc.data().nametutor} ${doc.data().apaternotutor} ${doc.data().amaternotutor}</div>
