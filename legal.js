   ...
   querySnapshot.forEach((doc) => {
    //doc.data() is never undefined for query doc snapshots
     console.log(doc.id, " => ", doc.data());
       ...
       //var todosd = document.urlParams.getAll('ID');
       document.urlParams.getAll('ID');.innerHTML = `<div><strong>Nombre del padre, madre o tutor:</strong> ${doc.data().nametutor} ${doc.data().apaternotutor} ${doc.data().amaternotutor}</div>
